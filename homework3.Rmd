...
```{r cfr-plot-3, message=FALSE, warning=FALSE}
...
```{r cfr-plot-4, message=FALSE, warning=FALSE}
...
```{r allow-scraping-opensecrets, eval=FALSE, warning=FALSE, message=FALSE}

# allow to scrape this website 
...
# clean country/parent co and contributions into tewo columns 
...
```{r scrape-pac, eval=FALSE}

# define scrape_pac function
scrape_pac <- function(x){
  x %>%
# take and read input x for URL 
  read_html(x)
# CSS selector for tables and create data frame out of the table 
...
# Define URLs for 2000, 2020, and 2022 contributions
...
-   efine the URLs for 2022, 2020, and 2000 contributions. Then, test your function using these URLs as inputs. Does the function seem to do what you expected it to do?
