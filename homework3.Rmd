...
cdc_data %>% 
  ...
  facet_grid(factor(icu_yn, levels = c("Yes","No"))~sex) + theme_light() +
  labs(x="",y="", caption = "Source: CDC",
       title="Covid CFR % by age group, sex and ICU Admission") +
  scale_x_continuous(labels=scales::percent) +
  guides(fill="none") +
  geom_text((aes(label=(sprintf("%0.0f",percentage*100)))), hjust=1, color= "black")
```
...
***ASK KOSTIS ABOUT WORD VS HTML AND DISCREPANCY IN Q1 PAYMENTS VS DONATIONS AND THE COVID GRAPH SCREW UP***
